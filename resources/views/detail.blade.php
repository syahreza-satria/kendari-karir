...
@section('content')
    ...
    <div class="space-y-4 text-sm font-light">
        <h1 class="text-2xl font-bold text-center">NatureVolution Indonesia - Fundraising and Partnerships
            Manager</h1>
        ...
        <p class="font-light leading-relaxed">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Atque quasi nihil ea
            quae. Explicabo
            aliquid
        ...
        <p>Kualifikasi:</p>
        <ul class="space-y-1 leading-relaxed list-disc list-inside">
        ...
        <p class="leading-relaxed">Jika anda berminat dan memenuhi kualifikasi diatas dapat mendaftarkan diri secara online
